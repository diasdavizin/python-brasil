...
peso_peixes = float(input("Digite a quantidade de kgs de peixe: "))

if peso_peixes <= 50:
   print("Você pescou",peso_peixes,"kgs de peixe e não teve excesso de kgs.")
else:
   peso_peixes > 50
   excesso = peso_peixes - 50
   multa = excesso * 4
   print("Você pescou",peso_peixes,"kgs de peixe e teve um excesso de:",excesso,"kgs. Sendo a multa de R$",multa)
